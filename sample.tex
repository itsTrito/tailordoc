...
\simpleheader{headercolour}{Tristan}{Brault Ouellette}{Dev}{white}
...
%<english>Hi my name is Jack
%<french>Bonjour, mon nom est Jack
...
%<*fr>
\section*{Résumé succinct}

\begin{tabular}{r| p{0.5\textwidth} c}
    \cvevent{2018--2021}{Capitaine du Black Pearl}{Chef d'équipe}{Inde orientale \color{cvred}}{Enfin récupéré ce foutu navire.\lorem\lorem\lorem}{disney.png} \\
    \cvevent{2016--2017}{Capitaine du Black Pearl}{Chef d'équipe}{Tortuga \color{cvred}}{Trouvé un trésor secret, perdu le navire. \lorem\lorem}{medal.jpeg}
\end{tabular}
\vspace{3em}
...
\section*{Diplômes}
\begin{tabular}{r p{0.6\textwidth} c}
    \cvdegree{1710}{Capitaine}{Certifié}{Université de Tortuga \color{headerblue}}{}{disney.png} \\
    \cvdegree{1715}{Corsaire}{M.A.}{Londres \color{headerblue}}{}{medal.jpeg} \\
    \cvdegree{1720}{Corsaire}{B.A.}{Londres \color{headerblue}}{}{medal.jpeg}
\end{tabular}
\end{minipage}\hfill
\begin{minipage}[t]{0.3\textwidth}
